...
/**
 * This class provides mock data for events.
 */
public class EventsMoc {
    ...
    public static ArrayList<Event> getEvents() {
        ...
        return new ArrayList<>(Arrays.asList(
                ...
                new Event("2", "Kids Art Workshop", "Arts & Crafts for children aged 6-9.", new Date(2024-1900, 6, 26, 14, 0), "456 University Ave W, Waterloo, ON", new ArrayList<>(Arrays.asList("Children (6-9 years)", "Arts & Crafts"))),
